...
#Define the dimensions for the analogue clock display
WIDTH = 300
HEIGHT = 300
...
#Create a canvas widget within the window to draw the clock face and hands
...
update_button = tk.Button(root, text="Update Clock", command=update_clock)
update_button.pack()
